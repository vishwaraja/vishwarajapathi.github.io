...
function revealOnScroll() {
    const reveals = document.querySelectorAll('.section-header, .about-content, .timeline, .skills-grid, .projects-grid, .contact-content');
...
console.log('%cThanks for checking out the code!', 'color: #6b7280; font-size: 14px;');
